...
Running these changes we can see every time we wiggle the values subtracting the finite difference from the original values decrease the cost toward zero.
